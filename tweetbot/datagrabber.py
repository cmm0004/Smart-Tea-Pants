...
class DataGrabber(object):
	...
	def getHourDeltaRecentTweet(self, userobject):
		...
		return '?'
	failures = []
	def saveRowsofFollowerData(self, all_ids):
		api = API()
